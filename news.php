...
if(!empty($_GET['id'])){
	$news = $db->boards()->where('id='.$_GET['id']);
}
$n = $news->fetch();
?>
            ...
            <td width="243" valign="top" background="images/rightbar_bg.gif"><table width="243" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="right" valign="bottom" bgcolor="#64AADE"><table width="243" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td><img src="images/licon_about062.jpg" alt="最新消息" width="243" height="80" border="0" longdesc="question_05.html" /></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
                ...
                <td><table width="737" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="680" class="text_indexin"><table width="680" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <td><table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td class="text_plastictaital"><table width="338" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="21"><strong class="hotnews_taitel"><img src="hot_news/taital.gif" width="16" height="30" ></strong></td>
                                    <td width="317"><strong class="hotnews_taitel"><?php echo $n['title']?></strong></td>
                                  </tr>
                                </table></td>
                              </tr>
                              <tr>
                              	<td colspan=2><?php echo $n['content']?></td>
                              </tr>
                            </table></td>
                          </tr>
                        </table></td>
                      ...
                      <tr>
                        <td valign="top" class="hotnews_box">&nbsp;</td>
                      </tr>
                      <tr>
                        <td valign="top"><table width="680" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="340"><span class="text_moreurl"><img src="hot_news/Previous.png" width="16" height="16" alt="previous" style="margin-bottom:-4px"/><a href="about_05.html" class="text_moreurl"> 回最新消息表單</a></span></td>
                            <td width="340" align="right">
                            	<span class="text_moreurl">
                            		<img src="hot_news/Previous.png" width="16" height="16" alt="previous" style="margin-bottom:-4px"/>
                            		<a href="news.php?less=<?php echo $n['id']?>" class="text_moreurl"> 上一篇</a>
                            	</span> │ 
                            	<span class="text_moreurl">
                            		<a href="news.php?more=<?php echo $n['id']?>" class="text_moreurl">下一篇 </a>
                            		<img src="hot_news/next.png" width="16" height="16" alt="next" style="margin-bottom:-4px"/>
                            	</span>
                            </td>
                          </tr>
                        </table></td>
