...
<div class="form">
	<label>類別：</label>
	<?php echo $form->dropDownList($model,'taxonomy_id', CHtml::listData(Taxonomy::model()->findAll(array('condition'=>'parent_id=11')), 'id', 'name'), array('empty'=>'---')); ?>
</div>
<div class="form">
	<label>圖片：</label>
	<div id="uuid_pix"></div>
...
$('#form_sub_btn').click(function(){
	...
	var params = $('#cosmetics-form').serialize();
	$.ajax({
