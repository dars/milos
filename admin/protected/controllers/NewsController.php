...
class NewsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$_POST['Boards']['created_at'] = date('Y-m-d H:i:s');
	...
	{
		$model=new Boards('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Boards']))
			$model->attributes=$_GET['Boards'];
	...
	{
		$model=Boards::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='boards-form')
		{
